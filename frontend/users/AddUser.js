          ...
          <div className='border rounded-xl border-gray-300 shadow my-12'>
            ...
            <form onSubmit={onSubmit} className="lg:p-16 p-6">
              ...
              <div className='flex justify-center'>
                ...
                <button 
                  type="button" // Changer à type="button"
                  onClick={() => navigate('/')} // Redirige vers la page d'accueil ou une autre page
                  className="w-52 h-12 shadow-sm rounded-full border border-red-800 text-red-800 hover:bg-red-800 hover:text-white transition-all duration-700 text-base font-semibold leading-7 mx-2"
                >
                  Cancel
                </button>
              </div>
