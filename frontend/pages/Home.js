                     ...
                     <tbody className="">
                         ...
                         users.map((user,index)=>(
                            <tr>
                             ...
                             <td>
                                <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mx-2">View</button>
                                <button className="bg-transparent border border-green-500 text-green-500 font-bold py-2 px-4 rounded hover:bg-green-500 hover:text-white mx-2">Edit</button>
                                <button className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded mx-2">Delete</button>
                            </td>
